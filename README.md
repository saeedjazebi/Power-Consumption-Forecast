...
### 3- Facebook Prophet Model
The training and testing data are prepared for the profit model. The model is then trained. made predictions for the test data period. A visual comparison is presented for the 24 hours following the training data. The RMSE is calculated as 2470.
